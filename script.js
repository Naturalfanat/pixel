...
var FILL_MODE = false
var COLORS = ['rgb(62, 62, 62)', 'rgb(255, 102, 46)', 'rgb(26, 218, 84)', 'rgb(83, 15, 255)', 'rgb(255, 236, 26)', 'rgb(142, 229, 255)', 'rgb(255, 255, 255)', 'rgb(251, 4, 156)']
...
color_cells.forEach(color_cell => {
    color_cell.addEventListener('click', function(){
        ...
        document.documentElement.cssText = `--current-color:${CURRENT_COLOR}`
